...
public class JCard extends SiebelSearch implements Impl
{
    ...
    public List<Map<String, String>> getItems(String job_id) throws SiebelException
    {
        ...
        map.put("1", getPropV.getProperty(V_OWNER_NAME));
        quoteItem.add(map);
        map = new HashMap();
        map.put("1", getPropV.getProperty(V_OWNER_ADDRESS));
        quoteItem.add(map);
        map = new HashMap();
        quoteItem.add(map);
        map = new HashMap();
        ...
        quoteItem.add(map);
        map = new HashMap();
        map.put("1", getPropV.getProperty(V_OWNER_EMAIL));
        quoteItem.add(map);
        map = new HashMap();
        map.put("1", getPropV.getProperty(V_OWNER_PHONE_NUMBER));
        ...
        map.put("10", getProp.getProperty(J_KM));
        quoteItem.add(map);
        map = new HashMap();
        quoteItem.add(map);
        map = new HashMap();
        ...
        map.put("6", getPropV.getProperty("Engine"));
        map.put("10", getProp.getProperty(J_DEADLINE));
        quoteItem.add(map);
        map = new HashMap();
        quoteItem.add(map);
        map = new HashMap();
        map.put("1", getProp.getProperty(J_REF_NUMBER));
        map.put("5", getProp.getProperty("Service Date"));
        map.put("8", getProp.getProperty("Fuel"));
    ...
    private SiebelPropertySet activateFields(String id) throws SiebelException
    {
        ...
        set.setProperty("Service Date", BLANK);
        set.setProperty("Fuel", BLANK);
        set.setProperty(J_BROUGHT_BY, BLANK);
        set.setProperty(V_ID, BLANK);
        set.setProperty(J_REF_NUMBER, BLANK);
