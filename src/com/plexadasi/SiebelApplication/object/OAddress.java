...
public class OAddress extends SiebelSearch implements Impl
{
    ...
    private List<Map<String, String>> orderItem(String account_id) throws SiebelException
    {
        ...
        set.setProperty("Ship To Account", "4");
        set.setProperty("Ship To", "5");
        set.setProperty("Ship To City State", "4");
        set.setProperty("Primary Order Id", "4");
        set.setProperty("Ship To Contact FullName", "4");
        //set.setProperty("Ship To First Name", "5");
        //set.setProperty("Ship To Last Name", "5");
        set.setProperty("Ship To Contact Cellular Phone", "4");
        ...
        //MyLogging.log(Level.INFO, String.valueOf(setProp));
        map.put("4", setProp.getProperty("Ship To Contact FullName"));
        quoteItem.add(map);
        map = new HashMap();
        map.put("4", setProp.getProperty("Ship To Contact Cellular Phone"));
        quoteItem.add(map);
        map = new HashMap();
